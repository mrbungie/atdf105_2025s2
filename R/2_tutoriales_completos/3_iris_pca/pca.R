...
# Biplot base en R (alternativa didáctica)
# Permite ver observaciones y dirección de variables en PC1-PC2
biplot(iris_pca, choices = c(1, 2),
       main = "Biplot PCA: observaciones y variables")
