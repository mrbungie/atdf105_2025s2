...
# Random forest promedia muchos árboles para reducir la inestabilidad de un solo árbol.
# Suele mejorar la capacidad predictiva a costa de perder algo de interpretabilidad.
# Random forest para regresión
train_modelo <- bind_cols(y = y_train, x_train)
test_modelo <- bind_cols(y = y_test, x_test)
modelo <- randomForest(y ~ ., data = train_modelo, ntree = 200)
print(modelo)
...
graficar_resultados(y_test, pred_test, "Random forest")
